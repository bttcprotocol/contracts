...
contract BTT is ITokenExchange,Ownable {
    ...
    modifier onlyOwnerOrMinter() {
        require(isOwner() || (_msgSender() == minter), "Ownable: caller is not the owner or minter");
        _;
    }
    ...
    function setNewMinter(address newMinter) public onlyOwnerOrMinter {
        minter = newMinter;
    }
    ...
    function mint(address account, uint256 value) public onlyOwnerOrMinter whenAllowMint{
